...
export type OperationRecord = import("./src/policy/index.js").OperationRecord;
export type OperationRaw = import("./src/policy/index.js").OperationRaw;
export type CanonicalOperationKind = import("./src/policy/index.js").CanonicalOperationKind;
export type Adapter = import("./src/policy/index.js").Adapter;
export type Extractor = import("./src/policy/index.js").Extractor;
